...
> Consolidated create/update form pairs into generic EntityForm pattern using @tanstack/react-form with Zod validation. Forms now share common field components, validation logic, and submission handling.
